...
def user_input():
    def submit():
            ...
            starting_infected = starting_infected_entry.get()  # New entry field for starting infected
            ...
            if not (1 <= int(starting_infected) <= 20):  # Validate starting infected between 1 and 20
